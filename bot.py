...
def is_youtube_link(text: str) -> bool:
    return "youtube.com/watch" in text.lower() or "youtu.be/" in text.lower()
...
async def ensure_subscribed(client: Client, m):
    ...
    try:
        ...
        kb = InlineKeyboardMarkup(
            [[InlineKeyboardButton("📢 Join Channel", url=FORCE_LINK or f"https://t.me/{FORCE_CH}")]]
        )
        await m.reply_text(
...
async def start_cmd(client, m):
    ...
    await m.reply_text(
        ...
        "Mujhe koi bhi YouTube link bhejo, main tumse quality poochungi:\n"
...
async def help_cmd(client, m):
    ...
    await m.reply_text(
        ...
        "`https://youtu.be/abc123` ya `https://www.youtube.com/watch?v=abc123`\n"
